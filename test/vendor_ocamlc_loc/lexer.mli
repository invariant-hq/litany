...
type lines = Single of int | Range of int * int
type code = { code : int; name : string }
type source = Code of code | Alert of string
...
type loc = { chars : (int * int) option; lines : lines; path : string }
