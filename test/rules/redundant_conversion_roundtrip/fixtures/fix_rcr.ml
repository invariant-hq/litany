...
let p1 = int_of_string (string_of_int n) (* FIRE *)
let p2 = bool_of_string (string_of_bool b) (* FIRE *)
let p3 = Char.chr (Char.code c) (* FIRE *)

(* Pipeline spellings collapse to direct applications. *)
let p4 = n |> string_of_int |> int_of_string (* FIRE *)
...
let p10 = C.chr (Char.code c) (* FIRE *)
